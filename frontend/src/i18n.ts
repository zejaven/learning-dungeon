...
const UI: Record<string, Localized> = {
  ...
  lessonStale: {
    en: 'The lesson was regenerated in another window. Reload it to continue.',
    ru: 'Урок был перегенерирован в другом окне. Перезагрузите его, чтобы продолжить.',
  },
  reloadLesson: { en: 'Reload lesson', ru: 'Перезагрузить урок' },
