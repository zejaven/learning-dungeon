...
const LABELS = {
  stack: { en: 'Stack — per thread (frames)', ru: 'Стек — на поток (кадры)' },
  heap: { en: 'Heap — shared (objects)', ru: 'Куча — общая (объекты)' },
  garbage: { en: 'garbage', ru: 'мусор' },
  runHint: {
    en: 'Run the code to see what lives on the stack and what lives on the heap.',
    ru: 'Запустите код, чтобы увидеть, что живёт на стеке, а что — в куче.',
  },
};
...
export default function JvmMemoryAreasVisualizer({ event }: VisualizerProps) {
