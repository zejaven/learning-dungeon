...
const LABELS = {
  ...
  runHint: {
    en: 'Run the code to see how HashMap stores entries in buckets.',
    ru: 'Запустите код, чтобы увидеть, как HashMap хранит записи в бакетах.',
  },
};
...
export default function HashMapBasicsVisualizer({ event }: VisualizerProps) {
